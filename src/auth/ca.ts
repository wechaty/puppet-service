...
const GET_WECHATY_PUPPET_SERVICE_SSL_SERVER_CERT = () => {
  return process.env['WECHATY_PUPPET_SERVICE_SSL_SERVER_CERT']
    ?.replace(/\\n/g, '\n')  || SSL_SERVER_CERT
}

const GET_WECHATY_PUPPET_SERVICE_SSL_SERVER_KEY = () => {
  return process.env['WECHATY_PUPPET_SERVICE_SSL_SERVER_KEY']
    ?.replace(/\\n/g, '\n') || SSL_SERVER_KEY
}
